...
int main() {
    int prx_test_program[] = {80,82,79,88,8,0,0,129,0,3,136,0,1,144,1,2,133,1,72,2,1,133,1,105,2,1,133,1,0,144,2,1,20,6,132,1,3,7,3,129,4,5,17,1,6,4,3,4,147,4,2,18,1,17,2,129,5,4,136,5,6,20,3,129,7,41,20,4,6,10,20,3,9,6,9,2,129,0,300,136,0,1,136,0,2,136,0,3,9,1,129,0,100,136,0,4,9,2,129,0,550,136,0,5,6,3,20,3,6,5,20,3,18,5,17,3,129,8,10,7,8,21,0,17,4,2,7,22,7,17,6,17,7,132,1,9,147,9,8,7,9,2,1,18,7,17,8,21,0,17,5,0,0};
    int prx_oversized_alloc_program[] = {80,82,79,88,0,129,0,2000,136,0,1};
    int prx_invalid_free_program[] = {80,82,79,88,0,129,0,3,136,0,1,129,2,999,9,2};
    int prx_missing_jump_label_program[] = {80,82,79,88,0,18,99};
    int prx_missing_branch_label_program[] = {80,82,79,88,0,147,0,99};
    int prx_missing_call_label_program[] = {80,82,79,88,0,20,99};
    int prx_stack_underflow_program[] = {80,82,79,88,0,21,0};
    int prx_stack_underflow_return_program[] = {80,82,79,88,0,22,0};
    int prx_truncated_program[] = {80,82,79,88,0,0};
